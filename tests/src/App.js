...
import './App.css';
import Index_html from './components/html_jsx';
import App_html from './components/app_jsx';
import Lose_html from './components/lose_jsx';
import Win_html from './components/win_jsx';
...
************************/
	function redimensionarPalco () {
		...
		//console.log('largura_tela: ', largura_tela, ' / altura_tela: ', altura_tela) //debug
	}
